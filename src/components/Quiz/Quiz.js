...
const Quiz = ({quiz}) => {
    ...
    return (
        <div>
            ...
            <FontAwesomeIcon className='text-xl text-red-600' icon={faEye} />
            <div className='grid grid-cols-1'>
                    <button 
                    onClick={() => handleClickAnswer(quiz.options[0])}
                    className='hover:bg-white text-lg font-bold text-red-400 border-2 border-red-400 rounded-xl px-5 py-3 my-3 mx-56'>
                    {quiz.options[0]}
                    </button>
